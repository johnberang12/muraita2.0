...
class Styles {
  ...
  static const k32Bold = TextStyle(
      fontSize: Sizes.p32, color: kBlack80, fontWeight: FontWeight.bold);

  static const k24 = TextStyle(fontSize: Sizes.p24, color: kBlack80);
  static const k24Grey = TextStyle(fontSize: Sizes.p24, color: kBlack40);
  static const k24Bold = TextStyle(
      fontSize: Sizes.p24, color: kBlack80, fontWeight: FontWeight.bold);

  static const k20 = TextStyle(fontSize: Sizes.p20, color: kBlack80);
  static const k20Grey = TextStyle(fontSize: Sizes.p20, color: kBlack40);
  static const k20Bold = TextStyle(
      fontSize: Sizes.p20, color: kBlack80, fontWeight: FontWeight.bold);

  static const k16 = TextStyle(fontSize: Sizes.p16, color: kBlack80);
  static const k16Grey = TextStyle(fontSize: Sizes.p16, color: kBlack40);
  static const k16Bold = TextStyle(
      fontSize: Sizes.p16, color: kBlack80, fontWeight: FontWeight.bold);

  static const k14 = TextStyle(fontSize: Sizes.p14, color: kBlack80);
  static const k14Grey = TextStyle(fontSize: Sizes.p14, color: kBlack40);
  static const k14Bold = TextStyle(
      fontSize: Sizes.p14, color: kBlack80, fontWeight: FontWeight.bold);

  static const k12 = TextStyle(fontSize: Sizes.p12, color: kBlack80);
  ...
  static const k8Bold = TextStyle(
      fontSize: Sizes.p8, color: kBlack80, fontWeight: FontWeight.bold);
}
